...
import { PowerUpType, Mission, MissionTarget } from './types';
...
export const INITIAL_TILE_VALUES: number[] = [2, 4, 8];
export const INITIAL_TILE_WEIGHTS: number[] = [0.6, 0.3, 0.1]; // Must sum to 1
...
export const AVAILABLE_POWERUPS: PowerUpType[] = [
  PowerUpType.BOMB,
  PowerUpType.DOUBLER,
